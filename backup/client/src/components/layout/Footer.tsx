      ...
      <div className="container mx-auto px-4 md:px-6">
        <motion.div 
          ...
          <motion.div variants={fadeInUp}>
            <Link href="/">
              <div className="inline-block mb-6 cursor-pointer">
                <img src={logoImg} alt="Godiva Tech Logo" className="h-10 w-auto bg-white rounded-md p-1" />
              </div>
            </Link>
            <p className="text-gray-400 mb-6">
              Providing innovative technology solutions to help businesses transform and thrive in the digital landscape.
            </p>
          ...
          <motion.div variants={fadeInUp}>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/services">
                  <div className="text-gray-400 hover:text-white transition-colors cursor-pointer">Services</div>
                </Link>
              </li>
              <li>
                <Link href="/about">
              ...
              <li>
                <Link href="/portfolio">
                  <div className="text-gray-400 hover:text-white transition-colors cursor-pointer">Portfolio</div>
                </Link>
              </li>
              <li>
                <Link href="/blog">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/services#web-development">
                  <div className="text-gray-400 hover:text-white transition-colors cursor-pointer">Web Development</div>
                </Link>
              </li>
              <li>
                <Link href="/services#mobile-development">
                  <div className="text-gray-400 hover:text-white transition-colors cursor-pointer">Mobile App Development</div>
                </Link>
              </li>
              <li>
                <Link href="/services#cloud-solutions">
                  <div className="text-gray-400 hover:text-white transition-colors cursor-pointer">Cloud Solutions</div>
                </Link>
              </li>
              <li>
                <Link href="/services#digital-marketing">
                  <div className="text-gray-400 hover:text-white transition-colors cursor-pointer">Digital Marketing</div>
                </Link>
              </li>
              <li>
                <Link href="/services#cybersecurity">
                  <div className="text-gray-400 hover:text-white transition-colors cursor-pointer">Cybersecurity</div>
                </Link>
              </li>
              <li>
                <Link href="/services#ai-ml">
                  <div className="text-gray-400 hover:text-white transition-colors cursor-pointer">AI & Machine Learning</div>
                </Link>
              </li>
            </ul>
          </motion.div>
          ...
          <motion.div variants={fadeInUp}>
            ...
            <ul className="space-y-3">
              <li className="flex">
                ...
                <span className="text-gray-400">123 Tech Park, Anna Nagar, Madurai, Tamil Nadu 625020, India</span>
              </li>
              <li className="flex">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary mt-1 mr-3" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span className="text-gray-400">+91 95000 12345</span>
              </li>
              <li className="flex">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary mt-1 mr-3" viewBox="0 0 20 20" fill="currentColor">
                ...
                <span className="text-gray-400">info@godivatech.com</span>
              </li>
            </ul>
          </motion.div>
        </motion.div>
        ...
        >
          <p className="text-gray-500 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Godiva Tech. All rights reserved.
          </p>
          <div className="flex space-x-6">
            ...
            <button className="text-gray-500 hover:text-white transition-colors">Sitemap</button>
          </div>
        </motion.div>
      </div>
    </footer>
